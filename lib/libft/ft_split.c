...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/25 18:35:15 by aclement          #+#    #+#             */
/*   Updated: 2023/01/25 18:51:13 by aclement         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_split(char const *s, char c)
{
	...
	if (!s)
		return (NULL);
	newstr = (char **)malloc(sizeof(char *) * (ft_nbwords(s, c) + 1));
	if (!(newstr))
		return (NULL);
	while (s[i])
	{
		...
		{
			newstr[j] = ft_substr(s, i, (ft_lenwords(&s[i], c)));
			if (!(newstr[j]))
